...
# source('2019-06-19-ascher-type-data/analysis3.1.r') # get data from UN 's API and save locally
source('2019-06-19-ascher-type-data/analysis3.2.r') # read local/ bee data
