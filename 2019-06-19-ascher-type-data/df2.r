...
describer_date <- fread(paste0(dir, "2019-05-23-Apoidea world consensus file Sorted by name 2019 filtered_3.2.2-describers.csv"), na.strings=c('', 'NA'), encoding="UTF-8", quote='"')
...
# Exclude these
to_exclude <- describer_data[prop_species_as_1st_author_s<0.1 & prop_species_described_not_1st_author > 0.9]$idx_auth
...
write.csv(described_per_year_final2, paste0(dir, "2019-05-23-Apoidea world consensus file Sorted by name 2019 filtered_3.2.4-describers_by_year.csv"), na='', row.names=F, fileEncoding="UTF-8")
