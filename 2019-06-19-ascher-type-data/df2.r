...
write.csv(describers, paste0(dir, "2019-05-23-Apoidea world consensus file Sorted by name 2019 filtered_3.2.0-describers_edit2.csv"), na='', row.names=F, fileEncoding="UTF-8")
...
describers <- fread(paste0(dir, "2019-05-23-Apoidea world consensus file Sorted by name 2019 filtered_3.2.0-describers_edit2.csv"), na.strings=c('', 'NA'), encoding="UTF-8", quote='"')
...
write.csv(describers_idx, paste0(dir, "2019-05-23-Apoidea world consensus file Sorted by name 2019 filtered_3.2.1-describers_edit.csv"), na='', row.names=F, fileEncoding="UTF-8")
...
describers <- fread(paste0(dir, "2019-05-23-Apoidea world consensus file Sorted by name 2019 filtered_3.2.1-describers_edit.csv"),
...
write.csv(describers, paste0(dir, "2019-05-23-Apoidea world consensus file Sorted by name 2019 filtered_3.2.2-describers_edit.csv"), na='', row.names=F, fileEncoding="UTF-8")
...
describers <- fread(paste0(dir, "2019-05-23-Apoidea world consensus file Sorted by name 2019 filtered_3.2.2-describers_edit.csv"),
            na.strings=c('', 'NA'), encoding="UTF-8", quote='"')
...
write.csv(describers, paste0(dir, "2019-05-23-Apoidea world consensus file Sorted by name 2019 filtered_3.2.3-describers_edit.csv"), na='', row.names=F, fileEncoding="UTF-8")

describers <- fread(paste0(dir, "2019-05-23-Apoidea world consensus file Sorted by name 2019 filtered_3.2.3-describers_edit.csv"),
            na.strings=c('', 'NA'), encoding="UTF-8", quote='"')
...
write.csv(describers, paste0(dir, "2019-05-23-Apoidea world consensus file Sorted by name 2019 filtered_3.2.4-describers_edit.csv"), na='', row.names=F, fileEncoding="UTF-8")
...
describers <- fread(paste0(dir, "2019-05-23-Apoidea world consensus file Sorted by name 2019 filtered_3.2.4-describers_edit.csv"), integer64='character', na.strings=c('', 'NA'), encoding='UTF-8')

describers2 <- fread(paste0(dir, "2019-05-23-Apoidea world consensus file Sorted by name 2019 filtered_3.2.1-describers_edit.csv"), integer64='character', na.strings=c('', 'NA'), encoding='UTF-8')
