...
df <- fread(paste0(dir_data, basefile, " filtered_4.3-clean-coll.csv"), 
...
# write.csv(df_mapper2[is.na(Country.final)], 'tmp/test.csv') 
# find a way to improve on this in the future
