...
ggsave(paste0(dir_plot, '_si/si-C-fig-2.png'), hist_tl_spp, units="cm", width=10, height=8, dpi=300)
...
hist_mean_spp <- ggplot(tax, aes(x=ns_species_per_year_active)) +
    ...
    geom_label_repel(data=tax_highlight, 
                     ...
                     box.padding = unit(0.001, 'lines')) +
theme
ggsave(paste0(dir_plot, '_si/si-C-fig-3.png'), hist_mean_spp, units="cm", width=10, height=8, dpi=300)
