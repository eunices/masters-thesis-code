...
# source("2020-08-31-jsa-type-v2-ch1/01-main.r")

# Set up
source('2020-08-31-jsa-type-v2-ch1/init.r')

source('2020-08-31-jsa-type-v2-ch1/01-main/in-text.r')

# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
# Section - Fig. 1
# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
source("2020-08-31-jsa-type-v2-ch1/01-main/fig-1.r")

# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
# Section - Fig. 2
# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
source("2020-08-31-jsa-type-v2-ch1/01-main/fig-2.r")
...
# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
source("2020-08-31-jsa-type-v2-ch1/01-main/si-A.r")

# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
# Section - SI 2B Fig - Histogram of active years
# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
source("2020-08-31-jsa-type-v2-ch1/01-main/si-B-fig-1.r")

# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
# Section - SI 2C Fig 1
# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
source("2020-08-31-jsa-type-v2-ch1/01-main/si-C-fig-1.r")

# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
# Section - SI 2D Table 1
# Describers profile - one large monograph towards end of life, or many small?
# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
source("2020-08-31-jsa-type-v2-ch1/01-main/si-D-table-1.r")

# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
# Section - SI 2E Tables - Ancillary info on describers
# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
source("2020-08-31-jsa-type-v2-ch1/01-main/si-E-tables.r")
