...
df_wos$rapid__is_deep_learning <- "MANUAL CHECK LATER"
df_wos$rapid__domain <- "MANUAL CHECK LATER"
df_wos$rapid__application <- "MANUAL CHECK LATER"
df_wos$rapid__data <- "MANUAL CHECK LATER"
df_wos$rapid__model_type <- "MANUAL CHECK LATER"

df_wos$eligibility__is_pri_research <- "MANUAL CHECK LATER"
df_wos$eligibility__is_not_software <- "MANUAL CHECK LATER"
df_wos$eligibility__is_dl_use_case <- "MANUAL CHECK LATER"
...
df_wos$notes <- "MANUAL CHECK LATER"
