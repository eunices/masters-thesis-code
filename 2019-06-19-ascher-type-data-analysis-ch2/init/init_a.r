...
dir_script_ed <- "2019-06-19-ascher-type-data-analysis-ch2/"
...
options(scipen = 999)
source('2019-06-19-ascher-type-data-analysis-ch2/init/util_a.r')
source('2019-06-19-ascher-type-data-analysis-ch2/init/util_stan.r')
